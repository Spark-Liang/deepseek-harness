...
export interface Config {
  /** Listen host; the supported values are loopback, all-interfaces, or a concrete IPv4 literal. */
  host: string
...
export class WebServer extends Service {
  static Config: z<Config> = z.object({
    host: z.string().pattern(/^((25[0-5]|(2[0-4]|1\d|[1-9]|)\d)\.){3}(25[0-5]|(2[0-4]|1\d|[1-9]|)\d)$/).required(),
